...
\begin{minipage}[t][0.82\textheight]{\linewidth}\vspace{0pt}
  \begin{cardA}{Step-by-step narrative}
  \begin{enumerate}
  ...
  \begin{card}{Only one difference between methods}
  Both methods use the same surrogate, BO horizon, candidate-pool size, and per-step mask budget. They differ only in \textbf{how masks are generated}.
  \end{card}
\end{minipage}

\column{0.46\textwidth}
\begin{minipage}[t][0.82\textheight]{\linewidth}\vspace{0pt}
  \begin{cardG}{Random vs. GFlowNet}
  ...
  \begin{cardW}{Why this slide matters}
  This is the core procedure narrative from the report: the talk now makes the BO loop explicit rather than only describing components.
  \end{cardW}
\end{minipage}
\end{columns}
\end{frame}
